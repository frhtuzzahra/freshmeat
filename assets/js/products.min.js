...
function edit(a) {
	$.ajax({
		...
		success: a => {
			$('[name="id"]').val(a.id), $('[name="kode_barang"]').val(a.kode_barang), $('[name="nama_produk"]').val(a.nama_produk), $('[name="satuan"]').append(`<option value='${a.satuan_id}'>${a.satuan}</option>`), $('[name="kategori"]').append(`<option value='${a.kategori_id}'>${a.kategori}</option>`), $('[name="harga"]').val(a.harga), $('[name="stok"]').val(a.stok), $(".modal").modal("show"), $(".modal-title").html("Edit Data"), $('.modal button[type="submit"]').html("Edit"), url = "edit"
		},
		error: a => {
			console.log(a)
		}

            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-sm-6">
                <div class="small-box bg-warning">
                  <div class="inner">
                    <h3 id="booking_terakhir">0</h3>
                    <p>Booking Transaksi Terakhir</p>
                  </div>
                  <div class="icon">
              ...
              <div class="col-md-6">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="chart">
                      <canvas id="produkTerlaris" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%"></canvas>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="card card-warning">
                  ...
                  <div class="card-body">
                    <div class="chart" style="height: 300px;max-height: 300px; overflow-y: scroll;">
